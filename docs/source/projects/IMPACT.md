...
## Workflow
Impact is assessed after Civic Intelligence synthesis (`../methodology/CIVIC_INTELLIGENCE.md`), never asserted independently of evidenced Knowledge Products.

## Roles
**Researcher, Institution** — assess and receive Impact findings respectively.

## Inputs
Civic Intelligence Reports and Recommendations.

## Outputs
Impact assessments, feeding Institutional Learning and Governance Improvement.

## Governance
No individual Impact score or ranking exists under any circumstance (Zero Gamification).
